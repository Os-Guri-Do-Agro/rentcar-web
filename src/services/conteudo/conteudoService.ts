...
export const getAllConteudo  = () => conteudoService.getAll()
...
export const createConteudo = (slug: string, titulo: string, conteudo: string) =>
  conteudoService.create(slug, titulo, conteudo)
export const updateConteudoById = (id: string, payload: any) =>
  conteudoService.updateById(id, payload)
